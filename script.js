...
const predefinedEmployees = [
    { id: 1, username: 'SHEIKH AHMER ALI', password: 'password123', role: 'ADMIN' },
    { id: 2, username: 'MUHAMMAD WAQAS', password: 'password123', role: 'employee' },
    { id: 3, username: 'MUHAMMAD YASEEN', password: 'password123', role: 'employee' },
    { id: 4, username: 'MUHAMMAD BILAL', password: 'password123', role: 'employee' },
    { id: 5, username: 'SYED KUMAIL NAQVI', password: 'password123', role: 'employee' },
    { id: 6, username: 'SHARIQ', password: 'password123', role: 'employee' },
    { id: 7, username: 'BILAL', password: 'password123', role: 'employee' },
    { id: 8, username: 'HASNAIN', password: 'password123', role: 'employee' },
    { id: 9, username: 'MURTAZA', password: 'password123', role: 'employee' },
